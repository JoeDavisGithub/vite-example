        ...
        <>
            ...
            <form className="createform" onSubmit={handleSubmit}>
                ...
                <div className="formtexts">
                    ...
                    <div>
                        <input type="text" name="actFirstName" value={firstName} required onChange={(e) => setFirstName(e.target.value)} ></input><br />
                        <input type="text" name="actLastName" value={lastName} required onChange={(e) => setLastName(e.target.value)} ></input><br />
